...
<br><br><br>
  <h3 class="text-center">Data Penjualan Harian Toko Boneka</h3> 
  ...
  <div class="card-body">
    <table class ="table table-bordered table-striped">
      ...
      <?php
        ...
        detail_bayar.id_detail JOIN boneka ON detail_bayar.id_boneka = boneka.id_boneka JOIN merk ON boneka.id_merk = merk.id_merk");
