  ...
  //jika tombol simpan diklik
   if(isset($_POST['bsimpan']))
   {
     ...
     if($_GET['hal']=="edit")
     {
       ...
       nama_merk='$_POST[tnama_merk]', model_boneka='$_POST[tmodel_boneka]'
     ...
     else
     {
       ...
       $simpan = mysqli_query($koneksi, "INSERT INTO merk (id_merk, nama_merk, model_boneka)
       VALUES ('$_POST[tid_merk]', '$_POST[tnama_merk]', '$_POST[tmodel_boneka]')");
   ...
   if(isset($_GET['hal']))
   {
     ...
     if($_GET['hal']=="edit")
     {
       ...
       if($data)
       {
         ...
         $vmodel_boneka= $data['model_boneka'];
       }
     }
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="boneka.php">Boneka</a>
        </li>
        <li class="nav-item">
...
<div class="card mt-3">
  ...
  <div class="card-body">
    ...
    <div class="form-group">   
        <label>Model Boneka</label>
        <input type="text" name="tmodel_boneka" value="<?=@$vmodel_boneka?>" class="form-control" placeholder="Input Model Boneka di sini!" required>
    </div>
